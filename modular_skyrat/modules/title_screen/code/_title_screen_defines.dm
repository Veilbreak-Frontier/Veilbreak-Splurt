...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_zzveilbreak/icons/UI_Icons/title_screen/VF_gtitle_screen4.png' // SPLURT EDIT START: TITLE SCREEN - old value: 'modular_skyrat/modules/title_screen/icons/skyrat_title_screen.png'
