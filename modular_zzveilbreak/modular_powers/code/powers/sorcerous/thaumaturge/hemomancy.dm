...
/datum/power/thaumaturge_root/hemomancy
	...
	species_blacklist = list(/datum/species/android, /datum/species/golem, /datum/species/plasmaman, /datum/species/ethereal, /datum/species/jelly, /datum/species/pod, /datum/species/snail) // You can't do blood magic without blood, duh!
	value = 5
