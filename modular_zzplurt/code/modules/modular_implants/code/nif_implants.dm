...
/obj/item/organ/cyberimp/brain/nif/standard/sobnif
...
/obj/item/organ/cyberimp/brain/nif/standard/sobnif/on_mob_insert(mob/living/carbon/human/H, special, movement_flags)
	. = ..()  // run parent behavior first
	if(H)
		// Apply the nanite happiness mood effect with custom text
		H.add_mood_event(
			"sob_nif_happy",
			/datum/mood_event/nanite_happiness,
			"Emotional regulation hijacked by unauthorized nanite routines"
		)

/obj/item/organ/cyberimp/brain/nif/standard/sobnif/on_mob_remove(mob/living/carbon/human/H, special, movement_flags)
	. = ..()  // run parent behavior first
	if(H)
