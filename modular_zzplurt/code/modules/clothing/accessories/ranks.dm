...
/obj/item/clothing/accessory/rank/private
	...
	desc = "A standard rank patch to designate what rank you are, this one is one Chevron, which indicates the rank of Private."
	icon_state = "chevron"

/obj/item/clothing/accessory/rank/specialist
	name = "Specialist rank patch"
	desc = "A standard rank patch to designate what rank you are, this one is a special shape of an upside down triangle with a rounded top, displaying a blue N on the front, which indicates the rank of Specialist."
